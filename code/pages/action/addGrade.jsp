...
<h4 class="text-break text-center text-info bg-light justify-content-center align-items-center">录入成绩</h4>
<form action="../AddGdAction.action" class="text-center text-info bg-light border-white align-items-center" method="post">
      <label>学号</label>
